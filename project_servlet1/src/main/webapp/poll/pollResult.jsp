...
String sql2 = " SELECT code,item,vote,(sum(vote) over()) as total FROM pollsub "
...
<table  class="table1">
	...
	<tr>
		...
		<td width="300">
			<div style="width:<%=ratio %>%;height:2px;background:red;">&nbsp;</div>
		</td>
	</tr>
	<%
	}
...
<div>
	<button type="submit" onclick="fn_submit();return false;">닫기</button>
</div>
</form>
</body>
</html>